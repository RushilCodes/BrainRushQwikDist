  ...
  return (
    <div class="mx-auto max-w-3xl px-4 py-10 text-gray-800">
      ...
      <footer class="pb-6 text-center text-sm text-gray-400">
        ...
        <a
          href="/privacy"
          class="p-5 text-sm text-blue-400 underline hover:text-blue-500"
        >
          Privacy Policy
        </a>
      </footer>
...
export const head: DocumentHead = {
  title: "Terms & Conditions | BrainRush",
  meta: [
    {
      name: "description",
      content:
        "Terms and conditions for using BrainRush.fun, a brain training game site.",
    },
  ],
};
